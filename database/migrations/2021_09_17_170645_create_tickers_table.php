...
class CreateTickersTable extends Migration
{
    ...
    public function up()
    {
        ...
        ('Selaras Citra Nusantara Perkas	','SCNP'),
        ('Organon Pharma Indonesia Tbk.	','SCPI'),
        ('Sidomulyo Selaras Tbk.	','SDMU'),
        ('Millennium Pharmacon Internati	','SDPC'),
        ('Bank Woori Saudara Indonesia 1	','SDRA'),
        ('Surya Fajar Capital Tbk.	','SFAN'),
        ('Sumber Global Energy Tbk.	','SGER'),
        ('Sampoerna Agro Tbk.	','SGRO'),
        ('Hotel Sahid Jaya International	','SHID'),
        ('Sillo Maritime Perdana Tbk.	','SHIP'),
        ...
        ('Boston Furniture Industries Tb	','SOFA'),
        ('Soho Global Health Tbk.	','SOHO'),
        ('Sona Topas Tourism Industry Tb	','SONA	'),
        ('Shield On Service Tbk.	','SOSS'),
        ...
        ('Trimegah Sekuritas Indonesia T	','TRIM'),
        ...
        ('Triniti Dinamik Tbk.	','TRUE'),
        ('Guna Timur Raya Tbk.	','TRUK'),
        ('Trust Finance Indonesia Tbk	','TRUS'),
        ('Tempo Scan Pacific Tbk.	','TSPC'),
        ('Asuransi Tugu Pratama Indonesi	','TUGU'),
        ('Tunas Ridean Tbk.	','TURI'),
        ('Pakuan Tbk.	','UANG'),
        ('Uni-Charm Indonesia Tbk.	','UCID'),
        ('Damai Sejahtera Abadi Tbk.	','UFOE'),
        ('Ultra Jaya Milk Industry & Tra	','ULTJ'),
        ('Unggul Indah Cahaya Tbk.	','UNIC'),
        ('Ulima Nitra Tbk.	','UNIQ'),
        ('Nusantara Inti Corpora Tbk	','UNIT'),
        ('Bakrie Sumatera Plantations Tb	','UNSP'),
        ('United Tractors Tbk.	','UNTR'),
        ('Unilever Indonesia Tbk.	','UNVR'),
        ('Urban Jakarta Propertindo Tbk.	','URBN'),
        ...
        ('Wahana Pronatural Tbk.	','WAPO'),
        ('Wijaya Karya Bangunan Gedung T	','WEGE'),
        ('WEHA Transportasi Indonesia Tb	','WEHA'),
        ...
        ('Wahana Ottomitra Multiartha Tb	','WOMF'),
        ...
        ('Yelooo Integra Datanet Tbk.	','YELO'),
        ('Yanaprima Hastapersada Tbk	','YPAS'),
        ('Yulie Sekuritas Indonesia Tbk.	','YULE'),
