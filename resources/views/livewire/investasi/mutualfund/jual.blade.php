<div>
    ...
    <div class="modal fade" wire:ignore.self id="jual-{{ $mutual_fund->id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="bg-black  modal-content">
                ...
                <div class="modal-footer border-0">
                    ...
                    <input type="submit" class="btn btn-primary" form="formjual-{{ $mutual_fund->id }}"
                        value="Sell" />
                </div>
            </div>
        </div>
