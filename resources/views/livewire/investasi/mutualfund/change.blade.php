<div>
    ...
    @endif
    <div class="modal__container" wire:ignore id="change-{{ $mutual_fund->id }}">
        <div class="bg-black modal__content">
            <div class="modal-header bg-gray-100 border-0">
                <h5 class="modal-title text-white">Change Mutual Fund Goal</h5>
                <button onclick="closeModal('change-{{ $mutual_fund->id }}')" class="close text-white">
            ...
            <div class="modal-footer border-0">
                <input type="submit" class="btn btn-primary btn-block" form="formchange-{{ $mutual_fund->id }}"
                    value="Update" />
            </div>
        </div>
    </div>
