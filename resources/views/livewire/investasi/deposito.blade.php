...
<div class="container-fluid small-when-0">
    ...
    <div class="card-body small-when-0">
        @forelse (auth()->user()->depositos as $deposito)
                ...
                <div
                    ...
                    <div class="dropdown no-arrow">
                        ...
                        <a class="this_small" href="#" data-toggle="modal"
                            data-target="#exampleModal-{{ $deposito->id }}">
                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                        </a>
            ...
            <div class="modal custom fade" id="exampleModal-{{ $deposito->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-body p-0">
                            <ul class="list-group p-0">
                                <a href="javascript:void(0)" data-dismiss="modal"
                                    wire:click="changeModal({{ $deposito->id }})"
                                ...
                                <a href="javascript:void(0)" wire:click="editModal({{ $deposito->id }})"
                                    data-dismiss="modal"
                                    class="list-group-item list-group-item-action bg-black  d-flex align-items-center">
                                    <div class="w-100 text-white">
