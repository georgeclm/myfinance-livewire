<div class="modal__container" wire:ignore.self id="change-{{ $deposito->id }}">
    <div class="bg-black modal__content">
        <div class="modal-header bg-gray-100 border-0">
            <h5 class="modal-title text-white">Change Deposito Goal</h5>
            <button onclick="closeModal('change-{{ $deposito->id }}')" class="close text-white">
        ...
        <div class="modal-footer border-0">
            <input type="submit" class="btn btn-primary btn-block" form="formchange-{{ $deposito->id }}"
                value="Change" />
        </div>
    </div>
</div>
