<div>
    ...
    @endif
    <div class="modal__container" wire:ignore.self id="jual-{{ $stock->id }}">
        <div class="bg-black modal__content">
            <div class="modal-header bg-gray-100 border-0">
                <h5 class="modal-title text-white">Sell Stock</h5>
                <button onclick="closeModal('jual-{{ $stock->id }}')" class="close text-white">
            ...
            <div class="modal-footer border-0">
                <input type="submit" class="btn btn-primary btn-block" form="formjual-{{ $stock->id }}"
                    value="Sell" />
            </div>
        </div>
    </div>
