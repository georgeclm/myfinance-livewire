<div>
    ...
    @endif
    <div class="modal__container" wire:ignore id="change-{{ $stock->id }}">
        <div class="bg-black modal__content">
            <div class="modal-header bg-gray-100 border-0">
                <h5 class="modal-title text-white">Change Stock Goal</h5>
                <button onclick="closeModal('change-{{ $stock->id }}')" class="close text-white">
            ...
            <div class="modal-footer border-0">
                <input type="submit" class="btn btn-primary btn-block" form="formchange-{{ $stock->id }}"
                    value="Update" />
            </div>
        </div>
    </div>
