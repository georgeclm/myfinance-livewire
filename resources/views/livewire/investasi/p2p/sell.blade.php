<div class="modal__container" wire:ignore.self id="sell-{{ $p2p->id }}">
    <div class="bg-black modal__content">

        <div class="modal-header bg-gray-100 border-0">
            <h5 class="modal-title text-white">Sell P2P</h5>
            <button onclick="closeModal('sell-{{ $p2p->id }}')" class="close text-white">
        ...
        <div class="modal-footer border-0">
            <input type="submit" class="btn btn-primary btn-block" form="formsell-{{ $p2p->id }}" value="Sell" />
        </div>
    </div>
</div>
