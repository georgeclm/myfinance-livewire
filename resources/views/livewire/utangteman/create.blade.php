<div>
    ...
    <div class="modal__container" wire:ignore id="create-friend-debt">
        <div class="bg-black modal__content">
            <div class="modal-header bg-gray-100 border-0">
                <h5 class="modal-title text-white">New Friends Debt </h5>
                <button onclick="closeModal('create-friend-debt')" class="close text-white">
            ...
            <div class="modal-body">
                <form id="rekening" wire:submit.prevent="submit">
                    <div class="form-group">
                        <input type="text" name="nama" required wire:model.defer="form.nama" placeholder="Debt from who"
            ...
            <div class="modal-footer border-0">
                <input type="submit" class="btn btn-primary btn-block btn-warning" form="rekening" value="Add" />
            </div>
        </div>
    </div>
</div>
